...
[win,winRect] = Screen('OpenWindow',0,0,[0,0,800,800]);
...
cfg.stepcolor = [0 128 255 0 255 128;10 20 30 40 50 60]; % default , colors with übergängen
...
for i = 1:length(counter)
    trigName(i) = 100 + counter(i);  %names of trigger 101, 102, 103...
end
