...
cfg.stepcolor = [0 128 255 0 255 128;10 20 30 40 50 60]; % default , colors with �berg�ngen nad triggernames
...
for color = constant
                ...
                triggerNum = color(2); %hier triggername bzw trigName noch anpassen �ndern!!!!!!!
                Screen('Flip', win);
